<footer class="bg-iyes-primary text-slate-300 font-sans border-t border-slate-800 relative overflow-hidden">
    
    {{-- <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-iyes-accent to-transparent opacity-50"></div> --}}
    <div class="absolute -top-24 -right-24 w-64 h-64 bg-iyes-accent/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="space-y-6">
                <div class="flex flex-col">
                    <span class="text-white font-[900] text-3xl tracking-tight leading-none">IYES INDONESIA</span>
                </div>


                <div class="space-y-3 pt-2">
                    <div class="flex items-start gap-3 group">
                        <div class="mt-1 w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-iyes-accent group-hover:bg-iyes-accent group-hover:text-white transition-colors flex-shrink-0">
            ...
            <div class="lg:pl-8">
                <h4 class="text-white font-bold text-lg mb-6 flex items-center gap-2">
                    <span class="w-8 h-0.5 bg-iyes-accent rounded-full"></span> Tautan
                </h4>
            ...
            <div>
                <h4 class="text-white font-bold text-lg mb-6 flex items-center gap-2">
                    <span class="w-8 h-0.5 bg-iyes-accent rounded-full"></span> Terhubung
                </h4>
                <p class="text-sm text-slate-400 mb-6">
                    Ikuti media sosial kami untuk update kegiatan terbaru IYES Indonesia.
                </p>
    ...
    <div class="border-t border-slate-900/50 bg-iyes-primary">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-xs text-slate-500 text-center md:text-left">
                &copy; {{ date('Y') }} <span class="text-slate-300 font-bold">IYES INDONESIA</span>. All Rights Reserved.
            </p>
            <div class="flex items-center gap-6">
                <a href="#" class="text-xs text-slate-500 hover:text-iyes-accent transition-colors">Privacy Policy</a>
                <a href="#" class="text-xs text-slate-500 hover:text-iyes-accent transition-colors">Terms of Service</a>
            </div>
        </div>
    </div>
</footer>