<x-layout>
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-6 w-full pt-16">
        <div class="max-w-3xl animate-fade-in-up">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6 drop-shadow-md">
                IYES <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">INDONESIA</span>
            </h1>
            
            <p class="text-white text-xl md:text-2xl font-light mb-10 leading-relaxed max-w-2xl drop-shadow-sm">
                Mewadahi pemuda untuk turut andil mengatasi permasalahan pendidikan, perdamaian, lingkungan, dan isu sosial melalui aksi kolektif.
            </p>
            
            <div class="flex flex-col sm:flex-row gap-4 mb-12">
                <a href="#programs" class="px-8 py-3.5 bg-iyes-accent text-white font-bold rounded-lg shadow-lg hover:bg-orange-600 hover:-translate-y-1 transition-transform">
                    Lihat Program
                </a>
                <a href="#" class="px-8 py-3.5 bg-white/10 backdrop-blur-md text-white font-bold rounded-lg border border-white/20 hover:bg-white/20 transition-colors">
                    Jadi Volunteer
                </a>
            </div>

            <div class="inline-flex flex-wrap gap-6 text-white/90 font-medium text-sm tracking-wide">
                <div class="flex items-center gap-2">
                    <span class="w-2 h-2 bg-iyes-accent rounded-full animate-pulse"></span> Pendidikan
                </div>
                <div class="flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-2 md:order-1">
                ...
                <p class="text-slate-600 text-lg leading-relaxed mb-8">
                    Menjadi platform terdepan yang menghubungkan pemuda Indonesia dengan peluang global, menciptakan pemimpin yang berkarakter, berwawasan luas, dan peduli terhadap isu-isu sosial berkelanjutan.
                </p>
                
                <ul class="space-y-5 mb-10">
                    <li class="flex items-start">
                        <div class="flex-shrink-0 w-6 h-6 rounded-full bg-green-100 flex items-center justify-center mt-1 mr-4">
                        ...
                        <div>
                            ...
                            <span class="text-slate-500 text-sm">Meningkatkan kapasitas soft-skill & hard-skill.</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mt-1 mr-4">
                            <svg class="w-3.5 h-3.5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <div>
                ...
                <a href="" class="group inline-flex items-center gap-2 px-6 py-3 bg-iyes-primary text-white font-bold rounded-lg hover:bg-slate-800 transition-all duration-300 shadow-lg shadow-blue-900/20">
    ...
    <section id="programs" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-6 text-center mb-16">
            ...
            <p class="text-slate-500 max-w-2xl mx-auto text-lg leading-relaxed">
                Jelajahi berbagai inisiatif kami yang dirancang khusus untuk memberdayakan potensi pemuda dan menciptakan dampak positif berkelanjutan.
            </p>
        </div>
        ...
        <div class="text-center mt-16">
            <a href="#" class="inline-block px-8 py-3 bg-iyes-primary text-white font-bold rounded-lg shadow-lg hover:bg-slate-800 hover:-translate-y-0.5 transition-all duration-300">
                Lihat Semua Program
            </a>
        </div>
    </section>
    ...
    <section id="news" class="py-24 bg-white border-t border-slate-50">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <a href="#" class="group inline-flex items-center font-bold text-iyes-primary hover:text-iyes-accent transition-colors">
                Arsip Berita
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12">
            ...
            <article class="group flex flex-col h-full">
                <a href="#" class="block relative aspect-[16/9] rounded-2xl overflow-hidden bg-gray-100 mb-5 shadow-sm">
                    ...
                    <span class="absolute top-4 left-4 bg-white px-3 py-1 rounded-lg text-xs font-bold text-iyes-primary shadow-sm">
                ...
                <div class="flex flex-col flex-grow">
                    ...
                    <h3 class="text-xl font-bold text-iyes-primary leading-snug mb-3 group-hover:text-iyes-accent transition-colors line-clamp-2">
                        <a href="#">{{ $post->title }}</a>
                    </h3>
                    ...
                    <a href="#" class="mt-auto inline-flex text-sm font-bold text-iyes-accent hover:underline decoration-2 underline-offset-4">
                        Baca Selengkapnya
                    </a>
                </div>
            </article>
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-6 text-center mb-16">
            ...
            <p class="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
                Cerita pengalaman nyata dari alumni, volunteer, dan mitra yang telah berkolaborasi bersama IYES Indonesia.
            </p>
        </div>

        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach($testimonials->take(3) as $testi)
            <article class="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center h-full">
                ...
                <blockquote class="text-slate-600 italic text-sm leading-relaxed flex-grow border-t border-slate-50 pt-4 w-full">
        ...
        <div class="text-center mt-12">
            <a href="#" class="inline-flex items-center text-iyes-primary font-bold text-sm hover:text-iyes-accent transition-colors group">
        ...
        <div class="max-w-3xl mx-auto px-6">
            ...
            <div class="space-y-4" x-data="{ selected: null }">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                    <button @click="selected !== 1 ? selected = 1 : selected = null" class="w-full flex justify-between items-center p-5 text-left font-bold text-iyes-primary hover:bg-slate-50 transition-colors">
                        <span>Bagaimana cara mendaftar program?</span>
                        <svg :class="selected === 1 ? 'rotate-180' : ''" class="w-5 h-5 text-iyes-accent transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                    <div x-show="selected === 1" x-collapse class="px-5 pb-5 text-slate-600 text-sm leading-relaxed border-t border-slate-50">
                        Anda bisa mendaftar melalui halaman detail program saat statusnya "Open Registration". Klik tombol daftar dan isi formulir yang tersedia.
                    </div>
                </div>

                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                    <button @click="selected !== 2 ? selected = 2 : selected = null" class="w-full flex justify-between items-center p-5 text-left font-bold text-iyes-primary hover:bg-slate-50 transition-colors">
                        <span>Apakah program IYES berbayar?</span>
                        <svg :class="selected === 2 ? 'rotate-180' : ''" class="w-5 h-5 text-iyes-accent transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                    <div x-show="selected === 2" x-collapse class="px-5 pb-5 text-slate-600 text-sm leading-relaxed border-t border-slate-50">
                        Ada program yang Fully Funded (Gratis) melalui seleksi beasiswa, dan ada jalur Self-Funded. Detailnya tertera di tiap panduan program.
                    </div>
                </div>
